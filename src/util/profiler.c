...
void profiler_print() {
    ...
    profiler_field_last(    render_pbs, 2);
    ...
    profiler_field_last(    tile_collision, 2);
    profiler_field_last(    pb_collision, 2);
    profiler_field_last(    tanks, 2);
    ...
    profiler_field_average(    render_pbs, 2);
    ...
    profiler_field_average(    tile_collision, 2);
    profiler_field_average(    pb_collision, 2);
    profiler_field_average(    tanks, 2);
